    ...
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            ...
            <div class="flex mt-4 sm:justify-center sm:mt-0">
                ...
                <!-- YouTube Icon -->
                <a href="https://youtube.com/@gragemediatechnology?si=TUzeCE_g9uFOHmda" class="text-gray-500 hover:text-gray-500">
                    <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                        viewBox="0 0 24 24">
                        <path fill-rule="evenodd"
                ...
                <!-- Instagram Icon -->
                <a href="https://www.instagram.com/pandaidigital_idn?igsh=MXM4aDBxcnprbDR1eQ==" class="text-gray-500 hover:text-gray-500">
                    <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                        viewBox="0 0 24 24">
                        <path fill-rule="evenodd"
