            ...
            <div class="mb-6 md:mb-0">
                @foreach ($cms as $company)
                    <a href="/home" class="flex items-center">
                        ...
                        <img src="https://teraskabeka.com/{{ $company->logo }}" class="h-8 me-2" alt="KeyFood Logo" loading="lazy"/>
                    </a>
            </div>
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-2">
                <div>
                    ...
                    <ul class="text-gray-500 font-medium">
                        ...
                        <li class="mb-4">
                            <a href="https://wa.me/6282118515748?text=Saya%20ingin%20bertanya%20tentang%20produk%20di%20website%20Teras KBK">Chat
                                Admin</a>
                        </li>
