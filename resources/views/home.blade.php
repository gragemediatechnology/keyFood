                    ...
                    <section class="section__container special__container" id="special">
                        ...
                        <div class="special__grid">
                            @foreach ($products as $product)
                                ...
                                <div class="special__card flex flex-col items-center justify-center text-center p-4 bg-white shadow-lg rounded-lg">
                                                        <img src="{{ $product->photo }}" alt="special" class="header-img mb-4 w-32 h-32 object-cover" />
                                                        ...
                                                        <div class="flex items-center justify-center mb-2">
                                                            ...
                                                            @for ($i = 1; $i <= $fullStars; $i++)
                                                                <svg xmlns="http://www.w3.org/2000/svg" class="text-yellow-500 w-5 h-5 fill-current"
                                                                    viewBox="0 0 16 16">
                                                                    <path
                                                            ...
                                                            @for ($i = 1; $i <= $emptyStars; $i++)
                                                                <svg xmlns="http://www.w3.org/2000/svg" class="text-gray-300 w-5 h-5 fill-current"
                                                                    viewBox="0 0 16 16">
                                                                    <path
                                                                        d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z" />
                                                                </svg>
                                                        ...
                                                        <div class="special__footer mt-4">
                                                            <span class="price text-lg font-semibold">Rp
                                                            ...
                                                            <form action="/detailed-store" method="POST">
                                                                ...
                                                                <button class="btn bg-blue-500 text-white mt-2 py-2 px-4 rounded-lg">Lihat
                                                                    Produk</button>
                                                            </form>
                                                        </div>
                                                    </div>
